...
public class DispatchFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            // uri: /OnlineLearningWebApp/(resource)
            int lastIndex = uri.lastIndexOf("/");
            String resource = uri.substring(lastIndex + 1); 
            
            ServletContext context = req.getServletContext();
            HashMap<String, String> conversionMap = (HashMap<String, String>) context.getAttribute("CONVERSION_MAP");
            
            // Iterate qua map để kiếm conversion
            // Nếu có thì gán vào url để dispatch resource tới controller/page
            if (conversionMap.isEmpty()) {
                throw new Exception("Empty Conversion Map or there is no 'CONVERSION_MAP' attribute.");
            } else {
            ...
            log("DispatchFilter: " + t.getMessage());
        }
    }
